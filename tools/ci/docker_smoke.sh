...
# Substitute: escrow, coworld-escrow, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-escrow:ci)
#   SMOKE_SLUG                 game slug                        (escrow)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/escrow)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/escrow-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-escrow:ci}}"
slug="${SMOKE_SLUG:-escrow}"
