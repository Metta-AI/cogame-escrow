...
test -s "${dist}/escrow_replay.wasm"
test -s "${dist}/escrow_replay.js"

rm -rf "${output_dir}"
mkdir -p "${output_dir}/assets"
cp "${dist}/escrow_replay.js" "${dist}/escrow_replay.wasm" "${output_dir}/"
